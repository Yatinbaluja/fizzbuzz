...
The program generates the first n Fibonacci numbers using the function F(n), printing
...
fibonacciSeries(1) #-> [0]  #Boundary case
fibonacciSeries(5) #-> [0, 1, 1, 2, 3]
fibonacciSeries(0) #-> AssertionError
fibonacciSeries(-1) #-> AssertionError #negative number
fibonacciSeries(2.5) #-> AssertionError #Data type other than int

prime(0) #-> False 
prime(1) #-> False #Base case
prime(2) #-> True  #Base case
prime(31)#-> True
prime(56)#-> False
prime(-1)#-> AssertionError #negative number
prime(7.5)#->AssertionError #Data type other than int

F(7) #Buzz Fizz 1 1 BuzzFizz Buzz BuzzFizz Fizz BuzzFizz 8
F(0) #-> AssertionError
F(-1)#-> AssertionError #negative number
F(2.5)#->AssertionError #Data type other than int
'''    
